...
public class NVPAPICaller
{
    ...
    /// <summary>
    /// Populates a new CheckoutErrorViewModel object from the passed in return data from the gateway.
    /// </summary>
    /// <param name="decoder"></param>
    /// <returns></returns>
    public CheckoutErrorViewModel PopulateGatewayErrorModel(NVPCodec decoder)
    {
        var errorVM = new CheckoutErrorViewModel
        {
