...
$resourceGroupName = "AzureDemoAvailabilitySet"
$location = "West Europe"
$asName = "DemoAvailabilitySet"
...
$storageAccountName = "pdufranceavset"
...
$newPublicIpParams = @{
    ...
    'DomainNameLabel' = 'pdufranceavailabilityset'
    'Location' = 'West Europe'
}
...
$vmConfig = New-AzureRmVMConfig @newConfigParams -AvailabilitySetId $availabilitySet.Id
